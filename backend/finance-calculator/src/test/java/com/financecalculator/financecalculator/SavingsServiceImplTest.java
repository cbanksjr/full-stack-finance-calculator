...
class SavingsServiceImplTest {
	...
	public void testMoneyInSavings() {
        ...
        assertEquals(1, savingsRepository.count(), "Savings repository should have one record");
        assertEquals(1, accountRepository.count(), "Account repository should have one record");
    }
