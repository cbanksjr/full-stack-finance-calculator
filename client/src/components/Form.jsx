...
const Form = () => {
  ...
  const handleSavingsSubmit = async (e) => {
    ...
    try{
        const response = await axios.post("http://localhost:8080/api/savings/allocateToSavings", data)
  ...
  return (
    <>
      ...
      >
      <h1 className="text-xl font-semibold mb-4">Enter your initial amount and percent to deduct from: </h1>
        ...
        <h1 className="font-semibold text-xl pt-12">Select where you would like to allocate your deduction:</h1>
